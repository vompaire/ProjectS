...
class NewsOut(models.Model):
    site = models.CharField(max_length=100, default="default_value_here")
    title = models.CharField(max_length=200)
    link = models.URLField()
    image = models.URLField(blank=True)
    data_public_from_site = models.CharField(max_length=100, default="default_value_here")

    def __str__(self):
        return f'{self.title} {self.link} {self.image} {self.site} {self.data_public_from_site}'
